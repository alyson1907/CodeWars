# https://www.codewars.com/kata/5287e858c6b5a9678200083c/solutions/ruby/me/best_practice
...
def narcissistic?(value)
  ...
  return value.to_s.split('').map(&:to_i).reduce(0){ |acc, n| acc += n**length } == value
end
